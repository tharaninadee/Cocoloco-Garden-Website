        ...
        if (!empty($_FILES["file"]["name"])) {
            ...
            if (in_array($fileType, $allowTypes)) {
                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                    $sql = "INSERT INTO packagecater(catergoryname, image,description,price) VALUES ('$catergoryname', '$fileName','$description','$price')";
...
<head>
    ...
    <title>Day Out Package:Admin</title>
...
<body>
<br><br><br>
<div class="topic"><img class="coco" width="80" height="50" style="margin-right:100px; margin-bottom:10px; margin-left:30px;" role="img" src="../Image/loco.png"> Add Day Out Package <button class="btn btn-brown" style="margin-bottom:10px; margin-left:500px;" onclick="goBack()"><-<-Go Back</button></div>
    ...
    <main class="m-2">
        ...
        <div class="justify-content-center">
            <div class="container" style="max-width:700px;">
                <form action="DayoutPacAdmin.php" method="POST" class="needs-validation" novalidate
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                            <label for="catergoryname" class="Adding-label">PackageName</label>
                        ...
                        <div class="col-sm-12">
                    <label for="price" class="Adding-label">Package Price</label>
...
<body>
<caption><h4>Day Out Package Table</h4></caption>   
<table class="AddingTable">
  
  <thead>
    <tr>
      
    <th scope="col">Package Catergory Name</th>
    ...
    <th scope="col">Action</th>
						...
						$query = $conn->query("SELECT * FROM `packagecater`") or die(mysqli_error());
     ...
     <td><?php echo $fetch['image'] ?><img src = "../Image/<?php echo $fetch['image']?>" height = "50" width = "50"></td>
        ...
        <a class="btn btn-danger"
            ...
            data-image-id="<?php echo $fetch['ImageId'] ?>"
            href="../Delete/delete_package.php?id=<?php echo $fetch['ImageId'] ?>">
