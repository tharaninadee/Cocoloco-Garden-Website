...
if (isset($_POST['additem'])) {
    ...
    if (empty($catergoryname) || empty($description) ){
        ...
        if (!empty($_FILES["file"]["name"])) {
            ...
            if (in_array($fileType, $allowTypes)) {
                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                    $sql = "INSERT INTO roomcater(catergoryname, image,description) VALUES ('$catergoryname', '$fileName','$description')";
...
<br><br><br>
<div class="topic"><img class="coco" width="80" height="50" style="margin-right:100px; margin-bottom:10px; margin-left:30px;" role="img" src="../Image/loco.png"> Add Room Package <button class="btn btn-brown" style="margin-bottom:10px; margin-left:500px;" onclick="goBack()"><-<-Go Back</button></div>
    ...
    <main class="m-2">
        <div class="justify-content-center">
            <div class="container" style="max-width:700px;">
                <form action="roomadmin.php" method="POST" class="needs-validation" novalidate
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                            <label for="catergoryname" class="Adding-label">Accomedation Package Name</label>
...
<body>
<caption><h4>Room Package Table</h4></caption>
  ...
  <thead>
    ...
    <th scope="col">Description</th>
      ...
      <th scope="col">Action</th>
						...
						$query = $conn->query("SELECT * FROM `roomcater`") or die(mysqli_error());
      ...
      <td><a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "../Delete/delete_Room.php?id=<?php echo $fetch['ImageId']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></td>
