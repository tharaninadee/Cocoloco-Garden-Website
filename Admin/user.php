...
<br><br><br>
<div class="topic"><img class="coco" width="80" height="50" style="margin-right:100px; margin-bottom:10px; margin-left:30px;" role="img" src="../Image/loco.png">Customer Details 
<button class="btn btn-brown" style="margin-bottom:10px; margin-left:600px;" onclick="goBack('user.php')">REFRESH</button>
...
<div class="container">
    ...
    <table class="tables">
        ...
        <?php
                if (isset($_POST['search'])) {
                    ...
                    $email = $_POST['email'];
                    $query = $conn->query("SELECT * FROM `users` WHERE contact = '$contactNumber' OR email = '$email'") or die(mysqli_error());
                } else {
    ...
    <tr>
                    ...
                    <td>
                        <a class="delete-btn" onclick="confirmationDelete(this); return false;" href="../Delete/delete_users.php?id=<?php echo $fetch['id']?>">
                            Delete
                        </a>
                    </td>
                </tr>
