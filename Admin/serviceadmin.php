        ...
        if (!empty($_FILES["file"]["name"])) {
            ...
            if (in_array($fileType, $allowTypes)) {
                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                    $sql = "INSERT INTO content (heading,description,image) VALUES ('$heading','$description','$fileName')";
                    if (mysqli_query($conn, $sql)) {
                        $msg2 = "You have successfully added the Service";
                    } else {
...
<?php include("navbonlyadmin.php") ?>
<br><br><br>
    <div class="topic"><img class="coco" width="80" height="50" style="margin-right:100px; margin-bottom:10px; margin-left:30px;" role="img" src="../Image/loco.png"> Add Cocoloco Service</div>
    ...
    <main class=" m-2">
        ...
        <div class="justify-content-center">
            ...
            <div class="container" style="max-width:700px;">
                ...
                <form action="serviceadmin.php" Method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                        <label for="heading" class="Adding-label">Heading</label>
                        <textarea class="form-control border-success" id="heading" name="heading"
...
<caption><h4>Cocoloco Service Table</h4></caption>
  ...
  <thead>
    ...
    <th scope="col">Heading</th>
      ...
      <td><?php echo $fetch['heading'] ?></td>
        ...
        <td><img src = "../Image/<?php echo $fetch['image']?>" height = "50" width = "50"></td>
        <td><a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "../Delete/delete_service.php?id=<?php echo $fetch['Id']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></td>
