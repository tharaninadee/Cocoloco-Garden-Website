    ...
    if (!empty($_FILES["file"]["name"])) {
        ...
        if (in_array($fileType, $allowTypes)) {
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                $sql = "INSERT INTO facility(catergoryname, image,description) VALUES ('$catergoryname', '$fileName','$description')";
                if (mysqli_query($conn, $sql)) {
                    $msg2 = "You have successfully added the Facility";
                } else {
...
<head>
    ...
    <title>Cocoloco : Facility Admin</title>
...
<body class="">
    ...
    <br><br><br>
    <div class="topic"><img class="coco" width="80" height="50" style="margin-right:100px; margin-bottom:10px; margin-left:30px;" role="img" src="../Image/loco.png"> Add Cocoloco Facility</div>
<br>
    ...
    <main class="m-2">
        ...
        <div class="justify-content-center">
            <div class="container" style="max-width:700px;">
                <form action="facilityadmin.php" method="POST" class="needs-validation" novalidate
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                            <label for="catergoryname" class="Adding-label">Facility Name</label>
...
<body>
<caption><h4>Facility table</h4></caption>
  ...
  <thead>
    ...
    <th scope="col">Description</th>
      ...
      <th scope="col">Action</th>
						...
						$query = $conn->query("SELECT * FROM `facility`") or die(mysqli_error());
      ...
      <td><?php echo $fetch['description'] ?></td>
        ...
        <td><a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "../Delete/delete_facility.php?id=<?php echo $fetch['ImageId']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></td>
