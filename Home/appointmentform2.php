...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $stmt = $mysqli->prepare("INSERT INTO appointment2(name, email, event, contact, time, description, date) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
?>
    ...
    <div class="topic">MAKE RESERVATION - TIME SLOT (03.00pm - 04.00pm)<button class="greenbutton" style="margin-bottom:10px; margin-left:300px;" onclick="goBack()"><-<-GO BACK</button></div>
  <div class="background-container"> 
    ...
    <script>
        function goBack() {
            ...
            var phpPage = 'appointcalender2.php';
