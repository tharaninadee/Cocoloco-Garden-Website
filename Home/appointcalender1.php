    ...
    $calendar.= "<a class='btn btn-CalenderBtn' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Next Month</a></center><br>";
     ...
     while ($currentDay <= $numberDays) {
         ...
         if($date<date('Y-m-d')){
             ...
             $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='appointmentform1.php?date=".$date."' class='btn btn-ReseBook'>Book</a>";
         }
...
<div class="topic"><img class="coocoo" width="80" height="50" style="margin-right:100px;margin-left:30px;" role="img" src="../Image/loco.png">SELECT DATE - TIME SLOT (11.00AM - 12.00PM)
